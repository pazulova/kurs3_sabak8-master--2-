...
class _CityViewState extends State<CityView> {
  ...
  await cityViewodel.getLocation();
                    ...
                    children: <Widget>[
                          ...
                          FlatButton(
                            onPressed: () async {
                              ...
                              if (_cityNameFromCityPage != null) {
                               ...
                               await cityViewodel.getWeatherByCityname(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: <Widget>[
                            Text(
                              cityViewodel.getWeatherModel.celcius.toString(),
